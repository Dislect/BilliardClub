...
namespace BilliardClub.Migrations
{
    ...
    [Migration("20220416195531_test11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BilliardClub.Models.TableRotation", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("TableRotation");
                });
            ...
            modelBuilder.Entity("BilliardClub.Models.TypeTable", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("TypeTable");
                });
            ...
            modelBuilder.Entity("BilliardClub.Models.AbstractFactory.EnRotation", b =>
                {
                    b.HasBaseType("BilliardClub.Models.TableRotation");

                    b.HasDiscriminator().HasValue("EnRotation");
                });

            modelBuilder.Entity("BilliardClub.Models.AbstractFactory.RusRotation", b =>
                {
                    b.HasBaseType("BilliardClub.Models.TableRotation");

                    b.HasDiscriminator().HasValue("RusRotation");
                });

            modelBuilder.Entity("BilliardClub.Models.AbstractFactory.EnType", b =>
                {
                    b.HasBaseType("BilliardClub.Models.TypeTable");

                    b.HasDiscriminator().HasValue("EnType");
                });

            modelBuilder.Entity("BilliardClub.Models.AbstractFactory.RusType", b =>
                {
                    b.HasBaseType("BilliardClub.Models.TypeTable");

                    b.HasDiscriminator().HasValue("RusType");
                });
